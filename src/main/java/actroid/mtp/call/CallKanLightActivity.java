 ...
 * 明カン画面
 */
public final class CallKanLightActivity extends Activity {
    
    /**
     * コンストラクタ
     */
    public CallKanLightActivity() {
    }
    ...
    protected void onCreate(final Bundle savedState) {
        ...
        setContentView(R.layout.activity_call_kan_light);
    ...
    private void initializeCancelButton() {
        final Button button = (Button)findViewById(R.id.button_call_kan_light_cancel);
    ...
    private void initializeJanPaiButton() {
        ...
        for (final Map.Entry<JanPai, Integer> entry : MTPConst.KAN_LIGHT_JAN_PAI_BUTTON_ID_MAP.entrySet()) {
    ...
    private final class JanPaiButtonListener implements View.OnClickListener {
        ...
        private MenTsu createMenTsu(final JanPai pai) {
            ...
            return new MenTsu(source, MenTsuType.KAN_LIGHT);
        }
